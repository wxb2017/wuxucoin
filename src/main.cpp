...
// Copyright (c) 2017 The Putaocoin developers
...
uint256 hashGenesisBlock("0x000008759f37c2876c56b13b94414dd00b5745a8f4b69e4010e897fc30d10c3a");
static const unsigned int timeGenesisBlock = 1498734000;
...
const string strMessageMagic = "Putaocoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "June 29, 2017. The Putaocoin release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040e5bf9ce47012dc422cf60230686d7fafe8e281b4bfe7e83d3a17eacf263482df07aac240739e65ad7ec9ee23a3e6a6f3de82dae11fe250e0bab3eae48d1111d") << OP_CHECKSIG;
        CBlock block;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xeb653acd9af0baf01dddd7e3dbcad3f6a00d528efc521e8c19a25220263ff32e"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xdf, 0xe0, 0x7a };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PutaocoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PutaocoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("PutaocoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Putaocoin-miner");
    ...
    try { loop {
        ...
        printf("Running PutaocoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("PutaocoinMiner terminated\n");
        throw;
    }
}
