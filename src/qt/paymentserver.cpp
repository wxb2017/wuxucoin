...
const QString BITCOIN_IPC_PREFIX("Putaocoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Putaocoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Putaocoin: click-to-pay handler");
    else
...
{
    // clicking on Putaocoin: URLs creates FileOpen events on the Mac:
